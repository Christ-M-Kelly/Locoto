...
<body>
        ...
        <div class="hero-content">
            <form class="rental-form" action="modifier_location.php" method="post">
                ...
                <div class="form-actions">
                    ...
                    <button type="button" class="action-btn delete-btn" onclick="supprimerLocation()">Supprimer</button>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Récupérer les détails de la location à partir de la base de données (exemple statique)
        $location_id = $_GET['id'];
    ...
    <script>
        function supprimerLocation() {
            if (confirm("Êtes-vous sûr de vouloir supprimer cette location ?")) {
                ...
                // Envoyer une requête AJAX ou rediriger vers un script PHP pour la suppression
                window.location.href = 'supprimer_location.php?id=' + location_id;
            }
        }
    </script>
